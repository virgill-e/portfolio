...
<template>
  <footer class="relative bg-transparent py-32 md:py-48 w-full flex flex-col items-center justify-center overflow-hidden z-20 border-t border-border-subtle mt-32">
    ...
    <div class="flex items-center gap-8 md:gap-12">
      ...
      <!-- LinkedIn -->
      <a href="https://www.linkedin.com/in/virgile-bigar%C3%A9/" target="_blank" class="text-text-muted hover:text-text-primary hover:-translate-y-1 transition-all duration-300" aria-label="LinkedIn">
        <svg class="w-8 h-8 md:w-10 md:h-10" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <!-- X / Twitter -->
      <a href="https://x.com/virgill_e" target="_blank" class="text-text-muted hover:text-text-primary hover:-translate-y-1 transition-all duration-300" aria-label="X">
        <svg class="w-8 h-8 md:w-10 md:h-10" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <!-- Instagram -->
      <a href="https://www.instagram.com/virgill_e/" target="_blank" class="text-text-muted hover:text-text-primary hover:-translate-y-1 transition-all duration-300" aria-label="Instagram">
        <svg class="w-8 h-8 md:w-10 md:h-10" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <!-- Email -->
      <a href="mailto:virgile.bigare@gmail.com" class="text-text-muted hover:text-text-primary hover:-translate-y-1 transition-all duration-300" aria-label="Email">
        <svg class="w-8 h-8 md:w-10 md:h-10" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
