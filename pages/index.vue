<template>
  <div class="bg-bg-primary text-text-primary min-h-app-screen relative selection:bg-text-primary selection:text-bg-primary overflow-x-hidden font-sans transition-colors duration-300">
    ...
    <!-- Main Content wrapper to ensure it sits above background -->
