<template>
  <div class="page-404 bg-bg-primary text-text-primary min-h-svh relative selection:bg-text-primary selection:text-bg-primary overflow-x-hidden font-sans transition-colors duration-300">
    ...
    <!-- Main Content -->
    <div class="relative z-10 flex flex-col min-h-svh">
