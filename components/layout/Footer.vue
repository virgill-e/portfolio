<template>
    <div class="h-[10vh] bg-custom-cream rounded-b-4xl relative z-30"></div>

    <div class="h-[40vh] bg-transparent pointer-events-none relative z-20"></div>

    <div
        class="h-[50vh] pt-[10vh] bg-custom-forest text-custom-cream fixed bottom-0 left-0 w-full z-10 flex flex-col justify-center items-center px-4">
